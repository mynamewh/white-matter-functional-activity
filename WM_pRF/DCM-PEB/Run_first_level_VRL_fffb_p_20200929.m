...
%     name = sprintf('sub-%02d',subj);
    ...
    % Load ROIs
    f = {fullfile(glm_dir,'VOI_V1p20200926_1.mat');
         fullfile(glm_dir,'VOI_LGNp20200928_1.mat')};    
    for r = 1:length(f)
        XY = load(f{r});
        xY(r) = XY.xY;
    end
...
% Find all DCM files
dcms = spm_select('FPListRec','/home/boyden/NeuroRaid/DataStorage/Data2017/White_matter_pRF/HCP_resting/DCM_REST1/DCM_GLM','DCM_full_FfFb20200929_p.mat');
...
% Check if it exists
if exist(fullfile(out_dir,'GCM_full_FfFb20200929_p.mat'),'file')
    opts.Default = 'No';
...
if tf
    ...
    % Save estimated GCM
    save('/home/boyden/NeuroRaid/DataStorage/Data2017/White_matter_pRF/HCP_resting/DCM_REST1/analyses_20200929/GCM_full_FfFb20200929_p.mat','GCM','-v7.3');
end

%% Run diagnostics
% load('/home/boyden/NeuroRaid/DataStorage/Data2017/White_matter_pRF/HCP_resting/DCM_REST1/analyses_20200717/GCM_full_FfFb20200717_p.mat');
